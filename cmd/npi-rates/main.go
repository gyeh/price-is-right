...
import (
	...
	modalorch "github.com/gyeh/npi-rates/internal/modal"
...
func newSearchCmd() *cobra.Command {
	...
	cmd.Flags().StringVarP(&outputFile, "output", "o", "", "Output file path (default: results_<timestamp>.json, use '-' for stdout)")
